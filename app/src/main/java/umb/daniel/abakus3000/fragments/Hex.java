 ...
 * {@link Hex.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Hex#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Hex extends Fragment {
     ...
     * @return A new instance of fragment Hex.
     */
    // TODO: Rename and change types and number of parameters
    public static Hex newInstance(String param1, String param2) {
    ...
    public void onButtonPressed(String text) {
        if (mListener != null) {
            mListener.hexOnFragmentInteraction(text);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void hexOnFragmentInteraction(String text);
    }

    private void addOnClickListeners(){
        final Button btn_a = view.findViewById(R.id.btn_a);
        final Button btn_b = view.findViewById(R.id.btn_b);
        final Button btn_c = view.findViewById(R.id.btn_c);
        final Button btn_d = view.findViewById(R.id.btn_d);
        final Button btn_e = view.findViewById(R.id.btn_e);
        final Button btn_f = view.findViewById(R.id.btn_f);
        ...
        btn_a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_a.getText().toString());
            }
        });
        ...
        btn_b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_b.getText().toString());
            }
        });
        ...
        btn_c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_c.getText().toString());
            }
        });
        ...
        btn_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_d.getText().toString());
            }
        });
        ...
        btn_e.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_e.getText().toString());
            }
        });
        ...
        btn_f.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onButtonPressed(btn_f.getText().toString());
            }
        });
